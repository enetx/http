...
//   $ bundle -o h2_bundle.go -prefix http2 -tags !nethttpomithttp2 gitlab.com/x0xO/http2
...
func (sc *http2serverConn) scheduleHandler(
	streamID uint32,
	rw *http2responseWriter, req *Request,
	handler func(ResponseWriter, *Request),
) error {
	sc.serveG.check()
...
func http2checkConnHeaders(req *Request) error {
	...
	if vv := req.Header["Connection"]; len(vv) > 0 &&
		(len(vv) > 1 || vv[0] != "" && !http2asciiEqualFold(vv[0], "close") && !http2asciiEqualFold(vv[0], "keep-alive")) {
